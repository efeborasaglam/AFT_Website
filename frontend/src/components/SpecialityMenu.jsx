                ...
                {disciplines.map((item, index) => (
                    ...
                    >
                        ...
                        'Individual athletic training sessions'
                            ? t('speciality.individualathltetic')
                            : item.speciality === 'Group Athletic Training'
                              ? t('speciality.groupathletic')
                              : item.speciality === 'Online-Coaching'
                                ? t('speciality.online')
